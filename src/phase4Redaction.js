...
import { V26_HEALTH_FIELDS } from './phase4V26Schema.js';
...
const FIELDS=Object.freeze({
  ...
  ...Object.fromEntries(Object.entries({...V23_HEALTH_FIELDS,...V24_HEALTH_FIELDS,...V25_HEALTH_FIELDS,...V26_HEALTH_FIELDS}).map(([t,f])=>[t,nulls(f)])),
});
