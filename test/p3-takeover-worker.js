...
parentPort.on('message', async (msg) => {
  ...
  try {
    ...
    const claim = await db.claimAnalyticsWork({ userId: msg.userId, cls: msg.cls, owner: msg.owner, leaseMs: msg.leaseMs, now });
    ...
    await db.settleAnalyticsWork({ userId: msg.userId, cls: msg.cls, owner: msg.owner, result: 'SUCCESS', generation, clearRange: msg.cls === 'light', now });
